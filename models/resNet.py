...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels,
        ...
        self.shortcut = nn.Identity() if stride == 1 and in_channels == out_channels else nn.Conv2d(in_channels, out_channels, kernel_size=1, stride=stride)
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes:int,
                 ...
                 block_list:Union[List[Tuple[int, int, int]], List[ResidualBlock]] = \
                    [(64,1,2),(64, 2, 2), (128, 1, 2), (128,2,2),(256,1,2),(256, 2, 2),(512,1,2) (512, 2, 2)],
                 bias=False, 
        ...
        if isinstance(start_block, nn.Module):
            ...
            img_size = (img_size-(start_block.kernel_size//2)*2+ 2*start_block.padding)//start_block.stride
        else:
            self.blocks.append(nn.Conv2d(self.in_channels, out_channels=start_block[0], kernel_size=start_block[1], stride=start_block[2], padding=start_block[3]))
        ...
        for block in block_list:
            if isinstance(block, nn.Module):
                ...
                img_size = (img_size-(block.kernel_size//2)*2+ 2*block.padding)//block.stride
        ...
        self.blocks.append(nn.Linear(in_chn*img_size[0]*img_size[1], num_classes))
